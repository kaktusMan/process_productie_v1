...
<div class="row">
    <div class="col-md-12">   
        <div class="form-group {{ $errors->has('nume') ? ' has-error' : '' }}">
            ...
            <select name="nume" id="nume"  class="form-control" data-search="5">
...
<div>
    <div class="row col-lg-12 text-center">
        ...
        <a href="{{route('componente::list') }}" class="btn btn-warning btn-lg button-widtht"><i class="fa fa-angle-left"></i> &nbsp;Inapoi</a>
    </div>
</div> 
