...
(function(e) {
    ...
    e.extend(n.prototype, {
        ...
        _constructor: function() {
            ...
            if (this.c.blurable) e(k).on("click.keyTable", function(c) {
                e(c.target).parents(".dataTables_filter").length && a._blur();
                e(c.target).parents().filter(b.table().container()).length || e(c.target).parents("div.DTE").length || e(c.target).parents().filter(".DTFC_Cloned").length ||
                    a._blur()
            });
        ...
        _focus: function(a,
            ...
            if (this.s.enable) {
                ...
                if (-1 !== f.length && (a < f.start || a >= f.start + f.length)) this.s.focusDraw = !0, g.one("draw", function() {
                    i.s.focusDraw = !1;
                    i._focus(a, b)
                    ...
                    if (c === o || !0 === c) this._scroll(e(m), e(k.body), h, "offset"), c = g.table().body().parentNode, c !== g.table().header().parentNode && (c = e(c.parentNode), this._scroll(c, c, h, "position"));
                    this.s.lastFocus = f;
            ...
            if (b && !(0 === a.keyCode || a.ctrlKey ||
                ...
                if (d) {
                    ...
                    if (!(this.c.keys && -1 === e.inArray(a.keyCode, this.c.keys))) switch (a.keyCode) {
                        ...
                        case 35:
                        case 36:
                            c && (a.preventDefault(), b = g.cells({
                                page: "current"
                            }).indexes(), this._focus(g.cell(b[35 === a.keyCode ? b.length - 1 : 0]), null, !0, a));
                            break;
                        case 37:
        ...
        _shift: function(a, b, c) {
            ...
            if (f) {
                ...
                i = h[d];
                "right" === b ? d >= h.length - 1 ? (j++,
                    i = h[0]) : i = h[d + 1] : "left" === b ? 0 === d ? (j--, i = h[h.length - 1]) : i = h[d - 1] : "up" === b ? j-- : "down" === b && j++;
                0 <= j && j < g && -1 !== e.inArray(i, h) ? (a.preventDefault(), this._focus(j, i, !0, a)) : !c || !this.c.blurable ? a.preventDefault() : this._blur()
            }
        },
        _tabInput: function() {
            var a = this,
    ...
    l.ext.selector.cell.push(function(a, b,
        c) {
        var b = b.focused,
            a = a.keytable,
            d = [];
        if (!a || b === o) return c;
        for (var e = 0, g = c.length; e < g; e++)(!0 === b && a.focused(c[e]) || !1 === b && !a.focused(c[e])) && d.push(c[e]);
        return d
    });
